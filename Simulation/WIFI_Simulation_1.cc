 ...
 *   n1     n2
 *
 * An HT station sends packets to the access point.
 * The average throughput, packet delivery and loss ratio and end-to-end delay received was reported under 5 seconds for both
   protocols with varying ditsances.
 */
...
int main (int argc, char *argv[]) {
        ...
        double distance = 10;                              /* Distance between the station node and AP node, beginning at 10 meters */
